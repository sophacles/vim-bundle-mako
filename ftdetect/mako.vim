...
if g:mako_detect_lang_from_ext
  au BufNewFile *.*.mako   execute "do BufNewFile " . expand("<afile>:r") | let b:mako_outer_lang = &filetype
  ...
  au BufReadPre *.*.mako   execute "do BufRead " . expand("<afile>:r") | let b:mako_outer_lang = &filetype
endif
